...
This crate provides an attribute macro [`#[culit]`](https://docs.rs/culit/0.6.6/culit/attr.culit.html) for “Custom Literals”. When applied to any statement, it enables using custom literals in that statement.
